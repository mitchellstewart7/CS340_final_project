module.exports = function(){
    ...
    function getItemOrders(res, mysql, context, complete){
        mysql.pool.query("SELECT orderID, itemID FROM ItemOrders", function(error, results, fields){
            if(error){
    ...
    router.post('/', function(req, res){
        ...
        {
            var mysql = req.app.get('mysql');
            var sql = "INSERT INTO ItemOrders (orderID, itemID) VALUES (?,?)";
            var inserts = [req.body.orderID, req.body.itemID];
    ...
    router.put('/:orderID/:itemID', function(req, res){
        var mysql = req.app.get('mysql');
        console.log(req.body)
        //console.log(req.params.id)
        var sql = "UPDATE ItemOrders SET orderID=?, itemID=? WHERE orderID=? AND itemID=?";
        var inserts = [req.body.orderID, req.body.itemID, req.params.orderID, req.params.itemID];
        sql = mysql.pool.query(sql,inserts,function(error, results, fields){
            if(error){
                console.log(error)
                res.write(JSON.stringify(error));
    ...
    router.delete('/:orderID/:itemID', function(req, res){
        var mysql = req.app.get('mysql');
        var sql = "DELETE FROM ItemOrders WHERE orderID = ? AND itemID = ?";
